...
public class Register extends JFrame {
  ...
  jf.setContentPane(new JLabel(new ImageIcon("C:\\Users\\shrey\\Downloads\\resources\\bg2.jpg")));
        ...
        jl.setBounds(700,125,500,50);
        jl.setForeground(new Color(0xFF8926));
        jf.add(jl);
        ...
        */
        ...
        jtf6.setFont(new Font("times new roman",Font.PLAIN,50));
...
jb.addActionListener((ActionEvent e) -> {
    ...
    if(fname==""||lname==""||cphno==""||email==""||door==""||lane==""||area==""||pin=="")
    {
        JOptionPane.showMessageDialog(jf, "Please Enter All The Fields");
    }
{
        try{
