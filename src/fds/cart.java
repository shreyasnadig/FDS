...
public class cart extends JFrame{
    ...
    jp1.setBounds(100, 850, 1700, 150);
    jp1.setOpaque(false);
    ...
    JLabel jl2=new JLabel(dname);
    jl2.setBounds(450,850,300,50);
    jl2.setFont(new Font("times new roman",Font.BOLD,35));
    jp1.add(jl2);
    ...
    JLabel jl4=new JLabel(dphno.toString());
    jl4.setBounds(1200,850,300,50);
    jl4.setFont(new Font("times new roman",Font.BOLD,35));
    jp1.add(jl4);
